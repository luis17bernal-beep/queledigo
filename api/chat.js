...
* Devuelve únicamente la respuesta final.`
  ...
  const userContent = hasImage
    ? [
        ...
        { type: 'text', text: `El mensaje recibido es: "${msg || 'Sin texto, responde a la imagen'}". Genera la respuesta según las instrucciones.` }
      ]
    : `El mensaje recibido es: "${msg}". Genera la respuesta según las instrucciones.`;
